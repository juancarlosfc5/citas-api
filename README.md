...
Este incremento implementa HU-005/006/007 por REST; no incluye UI ni recuperación de contraseña. El contrato está en `docs/wiki/llm-wiki/wiki/contracts.md`. Java 21/Spring Boot 3.5.0/Maven y la migración Flyway V1 se ejecutan en `develop`.
